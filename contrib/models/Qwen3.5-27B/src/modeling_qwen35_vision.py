"""
Qwen3.5-27B (Dense) Vision Encoder for NeuronX Distributed Inference.

Ports the Qwen3.5 ViT encoder to run on Neuron. The vision encoder
architecture is identical to the MoE variant (same patch embed, same rotary,
same merger) -- only out_hidden_size changes (5120 vs 2048, read from config).
