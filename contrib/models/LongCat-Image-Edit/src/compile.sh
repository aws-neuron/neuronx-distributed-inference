...
COMPILED_MODELS_DIR="${COMPILED_MODELS_DIR:-/opt/dlami/nvme/compiled_models_longcat}"
COMPILER_WORKDIR="${COMPILER_WORKDIR:-/opt/dlami/nvme/compiler_workdir_longcat}"
