#!/usr/bin/env python3
"""
LTX-2 E2E: Neuron Text Encoder + Neuron DiT Backbone
=====================================================
Both the Gemma 3-12B text encoder and the 48-block DiT transformer
run on Neuron (TP=4). They coexist on the same 4 NeuronCores and
execute sequentially: text encoding -> denoising.
...
def main():
    ...
    print("=" * 60)
    print(f"LTX-2 E2E: Neuron Text Encoder + Neuron DiT (TP={TP_DEGREE})")
    print("=" * 60)
    t_total = time.time()

    # 1. Create DiT config
    print("\n[1/6] Creating DiT config...")
    ...
    print("\n[2/6] Loading Diffusers LTX2Pipeline (CPU)...")
    t0 = time.time()
    ...
    print(f"\n[3/6] Loading Neuron DiT backbone from {DIT_COMPILE_DIR}...")
    ...
    print("\n[4/6] Swapping text encoder to Neuron...")
    t0 = time.time()
