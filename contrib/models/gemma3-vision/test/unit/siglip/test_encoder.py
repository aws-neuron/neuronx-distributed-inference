...
from test.utils import assert_tensor_all_close, mark_step, FP32_TOLERANCES, convert_neuron_siglip_encoder_state_dict_to_hf
...
hf_config.num_hidden_layers = 2    # lower num_hidden_layers for faster testing
