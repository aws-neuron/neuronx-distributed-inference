...
def compile_language_model_v3(args):
    ...
    world_size = int(os.environ.get("LM_WORLD_SIZE", 8))  # 4 for TP=4 CP=1, 8 for TP=4 CP=2
    ...
    with NxDParallelState(world_size=world_size, tensor_model_parallel_size=tp_degree):
        ...
        for rank in range(tp_degree):
            ...
            # Remove master_weight tensors. Clone because load_file returns mmap'd
            # tensors; overwriting the source file invalidates their backing storage.
