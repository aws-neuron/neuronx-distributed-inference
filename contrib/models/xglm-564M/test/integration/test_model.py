#!/usr/bin/env python3
"""
Integration tests for xglm-564M NeuronX implementation.
"""
...
# Test configuration
MODEL_PATH = "/home/ubuntu/models/xglm-564M/"
COMPILED_MODEL_PATH = "/home/ubuntu/neuron_models/xglm-564M/"
...
def create_model_for_inference(compiled_path: str, model_path: str):
    ...
    try:
        model_config = XGLMInferenceConfig.from_pretrained(
            model_path, neuron_config=neuron_config,
        )
    except (TypeError, AttributeError):
        model_config = XGLMInferenceConfig(
            neuron_config, load_config=load_pretrained_config(model_path),
        )
    
    model = NeuronXGLMForCausalLM(model_path, model_config)
...
if __name__ == "__main__":
    print("="*80)
    print("xglm-564M Integration Tests")
    print("="*80)
