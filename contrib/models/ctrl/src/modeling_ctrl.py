...
class CTRLNeuronConfig(NeuronConfig):
    ...
    def __init__(self, **kwargs):
        ...
        # Overridden after NeuronCTRLAttention is defined below
        self.attn_cls = None
...
# Set attention class now that NeuronCTRLAttention is defined (forward reference)
_orig_init = CTRLNeuronConfig.__init__


def _ctrl_neuron_config_init(self, **kwargs):
    _orig_init(self, **kwargs)
    self.attn_cls = NeuronCTRLAttention


CTRLNeuronConfig.__init__ = _ctrl_neuron_config_init
