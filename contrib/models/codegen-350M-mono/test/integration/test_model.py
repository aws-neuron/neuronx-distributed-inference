#!/usr/bin/env python3
"""
Integration tests for CodeGen-350M-mono NeuronX implementation.

This model uses the CodeGen architecture with:
- Parallel residual connections (attn + mlp computed in parallel on normed input)
- Partial rotary embeddings (32/64 dims with GPT-J interleaved rotation)
- Multi-head attention (16 heads, not GQA)
- Single LayerNorm per block
- Fused QKV projection with mp_num=4 and (Q,V,K) interleaved layout
"""
...
# Test configuration
MODEL_PATH = "/home/ubuntu/models/codegen-350M-mono/"
COMPILED_MODEL_PATH = "/home/ubuntu/neuron_models/codegen-350M-mono/"
...
def test_model_generates(compiled_model, tokenizer):
    """Test that model can generate code."""
...
if __name__ == "__main__":
    print("=" * 80)
    print("codegen-350M-mono Integration Tests")
    print("=" * 80)
