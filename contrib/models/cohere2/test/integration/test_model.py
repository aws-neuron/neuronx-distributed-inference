...
"""
from cohere2.fixed_hf_cache import HybridCache as FixedHybridCache, Cache as FixedCache
import transformers.cache_utils as hf_cache_utils
# For the integration test to pass with HuggingFace Transformers versions earlier than 4.52,  
# the HuggingFace HybridCache KV cache manager must be patched.  
# See Issue #37574: https://github.com/huggingface/transformers/issues/37574  
# The fix is included in HuggingFace Transformers version 4.52.  
hf_cache_utils.Cache = FixedCache
hf_cache_utils.HybridCache = FixedHybridCache
...
from cohere2.modeling_cohere2 import Cohere2NeuronConfig, Cohere2InferenceConfig, NeuronCohere2ForCausalLM
...
# Performance numbers computed on Trn1.32xlarge (TP8)
...
def test_model_accuracy_and_performance(batch_size, seq_len, ttft_threshold, throughput_threshold):
    ...
    print(benchmark_report["context_encoding_model"]["latency_ms_p50"])
    print(benchmark_report["token_generation_model"]["throughput"])
