#!/usr/bin/env python3
"""
Integration tests for OLMoE-1B-7B-0924 NeuronX implementation.

This model uses the OLMoE architecture with:
- Mixture of Experts (64 experts, top-8 routing)
- Q/K normalization (RMSNorm on Q and K after head split)
- Standard RoPE (full rotary, theta=10000)
...
MODEL_PATH = "/shared/dhwanw2/models/OLMoE-1B-7B-0924/"
COMPILED_MODEL_PATH = "/tmp/neuron_models/OLMoE-1B-7B-0924/"
...
if __name__ == "__main__":
    print("=" * 80)
    print("OLMoE-1B-7B-0924 Integration Tests")
    print("=" * 80)
