#!/usr/bin/env python3
"""
Integration tests for Phi-3.5-MoE-instruct NeuronX implementation.
"""
...
from modeling_phimoe import NeuronPhiMoEForCausalLM, PhiMoEInferenceConfig


# Test configuration
MODEL_PATH = "/home/ubuntu/models/Phi-3.5-MoE-instruct/"
COMPILED_MODEL_PATH = "/home/ubuntu/neuron_models/Phi-3.5-MoE-instruct/"
...
def create_model_for_inference(compiled_path: str, model_path: str):
    ...
    try:
        model_config = PhiMoEInferenceConfig.from_pretrained(
            model_path, neuron_config=neuron_config, trust_remote_code=True
        )
    except (TypeError, AttributeError):
        model_config = PhiMoEInferenceConfig(
            neuron_config, load_config=load_pretrained_config(model_path),
        )
    
    model = NeuronPhiMoEForCausalLM(model_path, model_config)
...
if __name__ == "__main__":
    print("="*80)
    print("Phi-3.5-MoE-instruct Integration Tests")
    print("="*80)
