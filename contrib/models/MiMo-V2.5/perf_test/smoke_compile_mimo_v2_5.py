#!/usr/bin/env python3
"""Minimal compile+load smoke test for MiMo-V2.5 FP8 on Trn2.

Bypasses vLLM entirely so we can iterate on the preprocessed Neuron-FP8
checkpoint without paying vllm-neuron's startup cost. Builds the MiMo-V2.5 BS=1
...
def main():
    ...
    neuron_config = MoENeuronConfig(
        ...
        # take the shard-on-block path via this flag.
