#!/usr/bin/env python3
"""
Setup patches for Mistral dense GQA models on SDK 2.29.

Applies to: Mistral 7B, Ministral 8B (any MistralForCausalLM with 32Q/8KV at TP=4).
...
For Ministral 8B, also run patch_config.py to fix sliding_window and layer_types.
...
def main():
    parser = argparse.ArgumentParser(
        description="Apply Mistral dense GQA NKI optimization patches (Mistral 7B, Ministral 8B)"
    )
    parser.add_argument(
        "--venv",
