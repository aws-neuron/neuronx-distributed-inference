#!/usr/bin/env python3
"""
Integration tests for Ouro-1.4B NeuronX implementation.

This model uses the Universal Transformer architecture with:
- 4 UT steps x 24 layers = 96 unrolled physical layers
- Dual pre+post norm sandwich (4 RMSNorms per layer)
- Intermediate RMSNorm at UT step boundaries
- Standard RoPE (theta=10000)
- SwiGLU activation
- Multi-head attention (16 heads, MHA)
...
MODEL_PATH = "/shared/dhwanw2/models/Ouro-1.4B/"
COMPILED_MODEL_PATH = "/tmp/neuron_models/Ouro-1.4B/"
...
if __name__ == "__main__":
    print("=" * 80)
    print("Ouro-1.4B Integration Tests")
    print("=" * 80)
