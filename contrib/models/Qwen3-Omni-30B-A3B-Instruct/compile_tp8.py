#!/usr/bin/env python3
"""Compile Qwen3-Omni text MoE + vision encoder at TP=8 (LNC=2).

Usage:
    source /opt/aws_neuronx_venv_pytorch_2_9_nxd_inference/bin/activate
    NEURON_RT_VISIBLE_CORES=0-15 python compile_tp8.py
"""
import sys
import time
...
COMPILED_PATH = "/home/ubuntu/traced_model/Qwen3-Omni-tp8"
TP_DEGREE = 8
...
print(f"Compiling text MoE + vision at TP={TP_DEGREE} (LNC=2) ...")
