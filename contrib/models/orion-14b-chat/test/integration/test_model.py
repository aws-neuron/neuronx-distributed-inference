#!/usr/bin/env python3
"""
Integration tests for orion-14b-chat NeuronX implementation.
"""
...
# Test configuration
MODEL_PATH = "/home/ubuntu/models/orion-14b-chat/"
COMPILED_MODEL_PATH = "/home/ubuntu/neuron_models/orion-14b-chat/"
...
def create_model_for_inference(compiled_path: str, model_path: str):
    ...
    try:
        model_config = OrionInferenceConfig.from_pretrained(
            model_path, neuron_config=neuron_config, trust_remote_code=True
        )
    except (TypeError, AttributeError):
        model_config = OrionInferenceConfig(
            neuron_config, load_config=load_pretrained_config(model_path),
        )
    
    model = OrionForCausalLM(model_path, model_config)
...
if __name__ == "__main__":
    print("="*80)
    print("orion-14b-chat Integration Tests")
    print("="*80)
