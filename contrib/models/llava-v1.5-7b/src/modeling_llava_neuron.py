"""
LLaVA Model Implementation for NeuronX Distributed Inference

This implementation ports LLaVA-v1.5-7b from HuggingFace transformers to run on AWS Trainium/Inferentia.

Architecture:
- Vision Tower: CLIP ViT-L/14@336px (reuses HuggingFace implementation)
- Multi-Modal Projector: 2-layer MLP with GELU activation
- Language Model: LLaMA-7B (reuses NeuronLlamaModel)
