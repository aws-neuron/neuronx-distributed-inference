#!/usr/bin/env python3
"""
Integration tests for lfm2-2.6b NeuronX implementation.
"""
...
from modeling_lfm2 import NeuronLfm2ForCausalLM, Lfm2InferenceConfig


# Test configuration
MODEL_PATH = "/home/ubuntu/models/lfm2-2.6b/"
COMPILED_MODEL_PATH = "/home/ubuntu/neuron_models/lfm2-2.6b/"
...
def create_model_for_inference(compiled_path: str, model_path: str):
    ...
    try:
        model_config = Lfm2InferenceConfig.from_pretrained(
            model_path, neuron_config=neuron_config,
        )
    except (TypeError, AttributeError):
        model_config = Lfm2InferenceConfig(
            neuron_config, load_config=load_pretrained_config(model_path),
        )
    
    model = NeuronLfm2ForCausalLM(model_path, model_config)
...
if __name__ == "__main__":
    print("="*80)
    print("lfm2-2.6b Integration Tests")
    print("="*80)
