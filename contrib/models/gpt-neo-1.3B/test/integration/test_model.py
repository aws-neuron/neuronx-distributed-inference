#!/usr/bin/env python3
"""
Integration tests for GPT-Neo-1.3B NeuronX implementation.

This model uses the GPT-Neo architecture with:
- Sequential residual connections (LN -> Attn -> Add -> LN -> MLP -> Add)
- Absolute position embeddings (learned, not rotary)
- Multi-head attention (16 heads, not GQA)
- Alternating global/local attention layers (treated as global for NXDI)
- Unscaled attention (no 1/sqrt(d_k) - cancelled via Q pre-scaling)
- Tied LM head weights (shared with token embeddings)
"""
...
# Test configuration
MODEL_PATH = "/home/ubuntu/models/gpt-neo-1.3B/"
COMPILED_MODEL_PATH = "/home/ubuntu/neuron_models/gpt-neo-1.3B/"
...
if __name__ == "__main__":
    print("=" * 80)
    print("gpt-neo-1.3B Integration Tests")
    print("=" * 80)
