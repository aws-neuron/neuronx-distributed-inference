...
# Common neuron config shared across all MiMo configs
...
echo "=========================================="
echo "MiMo-V2-Flash Performance Benchmark"
echo "=========================================="
...
###############################################################################
# Config 2: BS=32, TP=1/EP=64, CB + optimizations
###############################################################################
CONFIG_NAME="bs32_tp1_ep64_opt"
echo "--- Config 2: BS=32, TP=1/EP=64, CB + optimizations ---"
...
###############################################################################
# Config 3: BS=128, TP=1/EP=64, CB + optimizations
###############################################################################
CONFIG_NAME="bs128_tp1_ep64_opt"
echo "--- Config 3: BS=128, TP=1/EP=64, CB + optimizations ---"
...
echo "=========================================="
echo "MiMo-V2-Flash benchmarks complete!"
