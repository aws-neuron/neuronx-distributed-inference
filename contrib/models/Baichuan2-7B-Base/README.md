...
Measured on trn1.32xlarge, batch_size=1, seq_len=256, bfloat16. Utilization is per-NeuronCore (TP=2).

| Metric | Value |
|--------|-------|
| Throughput | 16.6 tok/s |
| Context Encoding MBU | 4.9% |
| Context Encoding MFU | 4.9% |
| Token Generation MBU | 5.4% |
