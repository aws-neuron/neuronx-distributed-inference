#!/usr/bin/env python3
"""
LTX-2.3 VAE Decoder — Standalone Compilation Script
====================================================
...
Usage:
  ...
  pip install "ltx-core @ git+https://github.com/Lightricks/LTX-2.git@ae855f8538843825f9015a419cf4ba5edaf5eec2#subdirectory=packages/ltx-core"

  # Compile 4x16 tile (recommended for 1024x1536 output)
  NEURON_RT_VISIBLE_CORES=0-3 python compile_vae_23.py \\
...
Notes:
  ...
  - LTX-2.3 has timestep_conditioning=True (unlike LTX-2)
"""
...
def main():
    parser = argparse.ArgumentParser(description="Compile LTX-2.3 VAE decoder with TP")
    parser.add_argument(
        "--height",
        type=int,
        default=128,
    ...
    parser.add_argument("--output-dir", type=str, default="/home/ubuntu/ltx23_vae_tp4")
    parser.add_argument(
        "--compiler-workdir", type=str, default="/home/ubuntu/compiler_workdir_vae23"
    )
    parser.add_argument(
        "--model-path",
        type=str,
