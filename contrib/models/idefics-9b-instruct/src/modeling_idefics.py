"""
NeuronX Distributed Inference implementation of Idefics model.

This implementation ports the Idefics-9B-Instruct model from HuggingFace to AWS Neuron hardware.
The model is a multimodal (vision-language) model based on LLaMA architecture with additional
cross-attention layers for vision-text fusion.
