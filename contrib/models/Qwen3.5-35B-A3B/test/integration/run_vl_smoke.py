...
"""
Vision-Language smoke test for Qwen3.5-35B-A3B on Neuron.
...
Usage:
    ...
    python contrib/models/Qwen3.5-35B-A3B/test/integration/run_vl_smoke.py \\
        --model-path /mnt/nvme/models/Qwen3.5-35B-A3B \\
        --compiled-path /tmp/qwen35_35b_a3b_vl_traced \\
...
def main():
    ...
    ap.add_argument("--compiled-path", default="/tmp/qwen35_35b_a3b_vl_traced")
