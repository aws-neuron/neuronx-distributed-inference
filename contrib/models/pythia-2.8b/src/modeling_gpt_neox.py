"""
GPTNeoX model ported to NeuronX Distributed Inference.

This implementation ports the HuggingFace GPTNeoXForCausalLM model to run on AWS Trainium/Inferentia
using the NeuronX Distributed Inference framework.
