#!/usr/bin/env python3
"""
Integration tests for Bloom-1b7 NeuronX implementation.

This model uses the Bloom architecture with:
- ALiBi positional encoding (no position embeddings)
- Pre-LayerNorm residual connections
- Multi-head attention (16 heads, MHA)
- Fused QKV projections (interleaved layout)
- Embedding LayerNorm after token embeddings
...
MODEL_PATH = "/shared/dhwanw2/models/bloom-1b7/"
COMPILED_MODEL_PATH = "/tmp/dhwanw_neuron_models/bloom-1b7/"
...
if __name__ == "__main__":
    print("=" * 80)
    print("Bloom-1b7 Integration Tests")
    print("=" * 80)
