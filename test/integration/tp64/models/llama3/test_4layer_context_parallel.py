...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(KERNEL_CONFIG_CP16_TP4, float('inf'), 0, False, 0.015),
        ...
        pytest.param(KERNEL_CONFIG_CP4_TP16, float('inf'), 0, False, 0.015),
        pytest.param(KERNEL_CONFIG_CP8_TP8, float('inf'), 0, False, 0.015, marks=pytest.mark.xfail),
        pytest.param(STRIDED_KERNEL_CP_SP_CONFIG_CP16_TP4, float('inf'), 0, False, 0.015),
        pytest.param(STRIDED_KERNEL_CP_SP_CONFIG_CP4_TP16, float('inf'), 0, False, 0.015),
        pytest.param(STRIDED_KERNEL_CP_CONFIG_CP16_TP4, float('inf'), 0, False, 0.015),
        pytest.param(STRIDED_KERNEL_CP_SP_CONFIG_CP8_TP8, float('inf'), 0, False, 0.015, marks=pytest.mark.xfail),
