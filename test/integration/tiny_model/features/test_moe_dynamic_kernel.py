...
class MoEWrapper(torch.nn.Module):
    ...
    def preshard_hook(self, model_state_dict: Dict[str, Any], prefix: str) -> None:
        ...
        create_spmd_ranks(
            ...
            n_routed_experts=self.moe.expert_mlps.routed_experts_mlp_config.num_experts,
...
class TestMoE:
    ...
    def test_moe_configurations_shard_on_intermediate_trn2(self, model_params, tp_degree_1, ep_degree_1, tp_degree_2, ep_degree_2):
