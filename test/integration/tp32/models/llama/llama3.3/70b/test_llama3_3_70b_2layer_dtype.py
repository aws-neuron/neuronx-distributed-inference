"""
Tests for Llama 3.3 70B model with different data types.
"""
...
NEURON_TEST_PARAMS = [
    pytest.param(
        ...
        272 * 1.2,  # latency_threshold
        939 * 0.8,  # throughput_threshold
        id="bfloat16"
    ),
    pytest.param(
        torch.float16,
        ...
        271 * 1.2,  # latency_threshold
        942 * 0.8,  # throughput_threshold
        id="float16"
    ),
    pytest.param(
        torch.float32,
        ...
        377 * 1.2,  # latency_threshold
        679 * 0.8,  # throughput_threshold
        id="float32"
    ),
]
...
def test_llama3_3_70b_2layer_neuron_on_device_sampling(
    torch_dtype, tol_map, divergence_difference_tol, latency_threshold, throughput_threshold
):
    """
    Test Llama 3.3 70B 2-layer model with different torch data types.
...
def test_llama3_3_70b_2layer_cpu_accuracy(torch_dtype, tol_map, divergence_difference_tol):
    """
    Test Llama 3.3 70B 2-layer model on CPU with different torch data types.
...
if __name__ == "__main__":
    ...
    for param in NEURON_TEST_PARAMS:
        ...
        test_llama3_3_70b_2layer_neuron_on_device_sampling(
            torch_dtype, tol_map, divergence_difference_tol, latency_threshold, throughput_threshold
        )
    ...
    for param in CPU_ACCURACY_THRESHOLDS:
        ...
        test_llama3_3_70b_2layer_cpu_accuracy(torch_dtype, tol_map, divergence_difference_tol)
