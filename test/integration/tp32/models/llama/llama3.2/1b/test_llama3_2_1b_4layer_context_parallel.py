...
@pytest.mark.parametrize(
    "neuron_config, num_kv_heads, latency_threshold, throughput_threshold",
    # fmt: off
    [
        (sp_neuron_config, 8, 274, 1056),
        (sp_disabled_neuron_config, 8, 277, 1034),
        (sp_neuron_config, 16, 276, 1057),
        (sp_disabled_neuron_config, 16, 286, 1023),
    ],
    # fmt: on
)
def test_llama3_2_1b_4layer_context_parallel(neuron_config, num_kv_heads, latency_threshold, throughput_threshold):
