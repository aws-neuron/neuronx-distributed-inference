...
Based on examples/generation_qwen3_moe_demo.py.

Usage:
    # Compile and generate:
    python generation_glm4_moe_demo.py

    # Skip compile (load from existing traced model):
    python generation_glm4_moe_demo.py --skip-compile
"""
...
def get_neuron_config(tp_degree: int = 2, seq_len: int = 64) -> MoENeuronConfig:
    """Create MoENeuronConfig for GLM-4.5 MoE tiny model."""
