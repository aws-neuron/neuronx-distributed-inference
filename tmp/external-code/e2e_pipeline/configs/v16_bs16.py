...
CONFIG = {
    ...
    'TRACED_MODEL_PATH': "/home/ubuntu/traced_model/gemma-3-27b-it-v16-bs16",
    'IMAGE_PATH': "/home/ubuntu/daanggn-neuron-inference-migration/scripts/dog.jpg",
    'MAX_NEW_TOKENS': 100,
    # Optimizations
    'QUANTIZED': True,
    'QUANTIZED_CHECKPOINTS_PATH': "/home/ubuntu/quantized_sd/gemma-3-27b-it-exclude-attn", # path to pre-quantized model state dict OR path to save quantized model state_dict
