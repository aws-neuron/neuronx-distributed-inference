...
from models.siglip.modeling_siglip import NeuronSiglipConfig, SiglipInferenceConfig, NeuronSiglipVisionTransformer
...
def test_nxdi_vision_transformer_vs_transformers_implementation(random_seed) -> None:
    ...
    reference_model.load_state_dict(vision_transformer.state_dict(), strict=True)
