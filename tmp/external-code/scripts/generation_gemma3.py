...
CONFIG = {
    ...
    'BATCH_SIZE': 1,
    'SEQ_LENGTH': 2048,
    'CTX_BUCKETS': [2048], # Set to a single bucket or powers of two between 128 and the SEQ_LENGTH.
    'TKG_BUCKETS': [2048], # Set to a single bucket or powers of two between 128 and the SEQ_LENGTH.
    'DTYPE': torch.bfloat16,
    'MODEL_PATH': f"{DATA_PATH}/model_hf/gemma-3-27b-it",
    'TRACED_MODEL_PATH': f"{DATA_PATH}/traced_model/gemma-3-27b-it",
    'IMAGE_PATH': f"{BASE_PATH}/scripts/dog.jpg",
    'MAX_NEW_TOKENS': 100,
    # Optimizations
    'QUANTIZED': False,
