...
"""
Modified version of neuronx-distributed-inference/src/neuronx_distributed_inference/utils/benchmark.py
Changes:
1. get_sample_inputs() tailored for Gemma3
"""
# flake8: noqa
import copy
import json
    ...
    **kwargs
    ...
    if target in ["all", "e2e"]:
        ...
        (
            ...
            # num_chunks,
            # has_image,
        ) = get_sample_inputs(END_TO_END_MODEL, model.config, sampling_params, image=image, **kwargs)
...
def get_sample_inputs(model_type, config: InferenceConfig, sampling_params, image=False, **kwargs):
    # Extract kwargs variables
    ...
    if model_type == END_TO_END_MODEL:
        ...
        if image:
            ...
            pixel_values, vision_mask = None, None
