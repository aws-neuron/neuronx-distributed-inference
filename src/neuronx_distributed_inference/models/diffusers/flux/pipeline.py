...
from neuronx_distributed_inference.models.diffusers.embeddings import FluxPosEmbed
...
class NeuronFluxPipeline(
    ...
    def __init__(
        self,
        scheduler: FlowMatchEulerDiscreteScheduler,
        vae: NeuronVAEDecoderApplication,
        text_encoder: NeuronClipApplication,
        tokenizer: CLIPTokenizer,
        text_encoder_2: NeuronT5Application,
        tokenizer_2: T5TokenizerFast,
        transformer: NeuronFluxBackboneApplication,
        image_encoder=None,
    ...
    def encode_prompt(
        ...
        assert lora_scale is None, "NeuronFluxPipeline does not support LoRA."
    ...
    # override the call method for Flux pipeline to pass image rotary embedding
    @torch.no_grad()
    def __call__(
        self,
        prompt: Union[str, List[str]] = None,
        ...
        image_rotary_emb = torch.stack(self.pos_embed(ids), dim=2).to(dtype=self.dtype)
